...
useEffect(() => {
  ...
  return (
    <div className="compact-card border-0 shadow-lg">
          ...
          <div className="flex-1 max-w-lg">
            <div className="relative group">
              ...
              <Input
                ...
                className="pl-10 pr-4 py-2 text-sm bg-white/60 backdrop-blur-sm border-white/20 rounded-lg shadow-md focus:shadow-lg focus:bg-white/80 transition-all duration-300 placeholder:text-slate-400 h-9"
              />
            </div>
          </div>
            ...
            <div className="flex items-center space-x-2 bg-white/60 backdrop-blur-sm rounded-lg p-2 shadow-md">
              <Button
                ...
                className={cn(
                  ...
                  isLiveData
                    ? "premium-gradient-green text-white shadow-md hover:shadow-lg pulse-glow"
